...
class CalculatorBrainTests: XCTestCase {
    ...
    func testSetOperand() {
        ...
        XCTAssertEqual(testBrain.evaluate().result, 5.0)
    }
    ...
    func testPerformOperation() {
        ...
        testBrain.performOperation("±")
        XCTAssertEqual(testBrain.evaluate().result, -129)

        testBrain.setOperand(5)
        testBrain.performOperation("×")
        testBrain.setOperand(8)
        testBrain.performOperation("=")
        XCTAssertEqual(testBrain.evaluate().result, 40)
        ...
        testBrain.performOperation("=")
        XCTAssertEqual(testBrain.evaluate().result, -7)
    ...
    func testAdditionalOperationsTask3() {
        ...
        testBrain.performOperation("х²")
        XCTAssertEqual(testBrain.evaluate().result, 324)
        
        testBrain.setOperand(4)
        testBrain.performOperation("x⁻¹")
        XCTAssertEqual(testBrain.evaluate().result, 0.25)
    }
    ...
    func testMissingParenthesisBug() {
        ...
        testBrain.performOperation("=")
        testBrain.performOperation("х²")
        XCTAssertEqual(testBrain.evaluate().description, "(4 + 5)²")
        XCTAssertFalse(testBrain.evaluate().isPending)
        ...
        testBrain.performOperation("=")
        testBrain.performOperation("x⁻¹")
        XCTAssertEqual(testBrain.evaluate().description, "(1 + 3)⁻¹")
        XCTAssertFalse(testBrain.evaluate().isPending)
        XCTAssertEqual(testBrain.evaluate().result, 0.25)
    }
}
